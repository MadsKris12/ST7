Materials contains a describtion of the given data of PFP subjects and which program there is used to form the deep learning model to predict the duration of the PFP. 
