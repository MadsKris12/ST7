...
A typical CNN architecture for characters recognition of the images, called LeNet-5, could be seen in \autoref{fig:LeNet5}.The way this convolutional network works is 
