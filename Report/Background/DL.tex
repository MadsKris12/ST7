...
The architecture of a typical CNN’s are almost always combined with another layer type called pooling \citep{Goodfellow2016, LeCun2015}.

Convolutional neural networks (CNNs) perform highly in several tasks, including digit recognition, image classification and face recognition. The key aspect of CNNs is to automatically learn a complex model by extracting visual features from the pixel-level content.\citep{Acquarelli2017}¨
