...
The network can be split into two main phases, where the first phase is a feedforward pass of the network, and then a learning phase. 
When practicing supervised learning, an input is given to the network, to which a output is calculated, e.g. a classification value, that is then compared to a desired output.   


Backpropagation is also the most general methods for supervised learning \citep{Duda2000}
