...
Gradient descent is one of the most common algorithms for optimizing neural networks. It is a way to minimize the loss function (cost function) by updating the parameters in the opposite direction of the gradient of the objective function. [GD] More detailed explanatory is given in figure 5.1.
