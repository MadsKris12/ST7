...
\caption{Dropout effect: (a) illustrates a fully connected network without dropout, and (b) shows a network where dropout is enabled on the first three layers. Edited \citep{Srivastava2014}.}
\label{fig:Dropout} 
\end{figure}
