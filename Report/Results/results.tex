...
In order to find the optimal model with the highest generalization performance, the output of pain intensity and pain duration was compared.
In addition (or Later), the performance of different data representations (morphology, location and combined), with gender included, was additionally evaluated to determine if form, location or combination of both, could be kept as meaningful feature while classifying pain duration and intensity. 
Final optimal model is chosen after comparing the scores of all 6 models, presented in table /ref{final result table}. Furthermore, type 1 and type 2 errors could be seen in confusion matrices shown in figure /ref{confusionblabla}.
