...
\end{tabular}
\caption{Hyperparameters were chosen for each model after initial grid search.}
\label{tab:damn}
\end{table}
\noindent
For the deep learning models including MR different hyperparameters were used to obtain the highest performance. The models including the LR had similar results from the optimization. Furthermore, the model including the CR had almost identical hyperparameters except the learning rate. 
