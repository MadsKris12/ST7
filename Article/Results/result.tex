...
Pain duration  & \hspace{0.7cm}\begin{tabular}[c]{@{}l@{}}59.51\% \end{tabular} & \hspace{2.6cm} \begin{tabular}[c]{@{}l@{}}62.16\%\end{tabular} & \hspace{2.7cm} \begin{tabular}[c]{@{}l@{}} 62.20\%\end{tabular} \\ %\midrule
